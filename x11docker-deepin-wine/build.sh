...
#git clone https://github.com/hongyi-zhao/dockerfile-x11docker-deepin.git dockerfile-x11docker-deepin.git
#cd dockerfile-x11docker-deepin.git
...
docker build --network host --build-arg http_proxy='' --build-arg https_proxy='' \
             ...
             -t ${DOCKER_REPO_DEEPIN_WINE}:${DOCKER_TAG} .
